...
df_most_reviewed = pd.read_csv('recommended most reviewed.csv')
...
df_avg_rating = pd.read_csv('app/recommendations/recommendations-ratings-avg.csv')
...
df_weighted_rating = pd.read_csv('app/recommendations/recommendations-ratings-weight.csv')
