...
df_movies = pd.read_csv('strijdervis/recommendation-system/main/Workshop recommender systems/data/movies.csv', low_memory=False)
...
df_most_reviewed = pd.read_csv('strijdervis/recommendation-system/main/Workshop recommender systems/recommendations/recommendations-most-reviewed.csv')
...
df_avg_rating = pd.read_csv('strijdervis/recommendation-system/main/Workshop recommender systems/recommendations/recommendations-ratings-avg.csv')
...
df_weighted_rating = pd.read_csv('strijdervis/recommendation-system/main/Workshop recommender systems/recommendations/recommendations-ratings-weight.csv')
...
df_freq_reviewed = pd.read_csv('strijdervis/recommendation-system/main/Workshop recommender systems/recommendations/recommendations-seeded-freq.csv')
